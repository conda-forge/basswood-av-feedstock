...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/basswood-av-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/basswood-av-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add basswood-av
# for installing globally
pixi global install basswood-av
```
...
It is possible to list all of the versions of `basswood-av` available on your platform:
...
```
pixi search basswood-av --channel conda-forge
```
